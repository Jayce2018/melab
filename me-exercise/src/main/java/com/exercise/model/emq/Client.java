...
public class Client {
    ...
    public static final String TOPIC = "serverToClient/#";
    ...
    private void start() {
        try {
            ...
            MqttTopic topic = client.getTopic(TOPIC1008601);
            ...
            //订阅消息
            int[] Qos = {1};
            String[] topic1 = {TOPIC1008601};
            //client.subscribe(topic1, Qos);
            client.subscribe("serverToClient/#",2);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
